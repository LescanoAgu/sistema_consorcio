...
import { Archive, AlertCircle, CreditCard, User, FileText, Calculator, Settings, Calendar } from 'lucide-react';
  ...
  const handleClose = async () => {
      ...
      try {
          ...
          if (confirm("Liquidación cerrada. ¿Desea enviar las notificaciones de cobro por email a los propietarios ahora?")) {
              ...
              else alert("Hubo un error enviando algunos correos.");
          }
      } catch (error) {
          console.error(error);
